    ...
    try {
        data.forEach(function (feeAssignmentDetail) {
            ...
            convertFeeAssignmentDetailsObj.feeAssignmentDetailId = feeAssignmentDetail['fee_assignment_detail_id'],
                ...
                convertFeeAssignmentDetailsObj.totalAmount = parseInt(convertFeeAssignmentDetailsObj['feeDiscountAmount']) + parseInt(totalScholarShipAmount) + parseInt(convertFeeAssignmentDetailsObj['netAmount']),
