...
function convertDepartment(req, data) {
    ...
    if(_.isEmpty(data)) {
        ...
        try {
            ...
            departmentObj.updated_username= data['updated_username'] + '-' + updatedDate;
...
function convertDesignation(req, data) {
    ...
    if(_.isEmpty(data)) {
        ...
        try {
            ...
            designationObj.updated_username= data['updated_username'] + '-' + updatedDate;
...
function convertLeaveTypeObj(req, data) {
    ...
    if(_.isEmpty(data)) {
        ...
        try {
            ...
            leaveTypeObj.updated_name= data['updated_username']  + '-' + updatedDate || '';
